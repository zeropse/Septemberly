      ...
      <Card className="bg-black/10">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-center space-y-2">
            <div className="text-lg font-medium text-yellow-400">{currentLevel.name}</div>
            <div className="text-sm opacity-80">
              Total XP: <span className="font-bold text-green-400">{totalXP}</span>
            </div>
          </div>
          ...
          {recentActions.length > 0 && (
            <div className="space-y-2">
              <div className="text-sm font-medium text-center">Recent Activities</div>
                ...
                {recentActions.slice(0, 3).map((action) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 ml-2">
                      ...
                      {action.levelUp && <span className="text-yellow-400">🎉</span>}
                    </div>
                  </div>
                ))}
              </div>
