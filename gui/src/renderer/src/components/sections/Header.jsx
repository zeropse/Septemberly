    ...
    <>
      <header className="flex items-center justify-between mb-4 md:mb-6 px-2 sm:px-4 md:px-0">
        <div className="flex items-center gap-2 sm:gap-3">
          <IconLeaf2 className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" aria-hidden="true" />
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold truncate">Septemberly</h1>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md mx-4 sm:mx-0">
              ...
              <DialogDescription>Configure theme and reset application data.</DialogDescription>
              <Settings />
              <DialogClose />
            </DialogContent>
          </Dialog>
