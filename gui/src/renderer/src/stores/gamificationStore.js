  ...
  persist(
    (set, get) => ({
      ...
      getCurrentLevelInfo: () => {
        ...
        return (
          LEVEL_THRESHOLDS.find(
            (level) => state.totalXP >= level.minXP && state.totalXP <= level.maxXP
          ) || LEVEL_THRESHOLDS[0]
        )
      },
      ...
      getProgressToNextLevel: () => {
        ...
        const xpNeededForCurrentLevel = nextLevel.minXP - currentLevelInfo.minXP
        const progress = (progressInCurrentLevel / xpNeededForCurrentLevel) * 100
