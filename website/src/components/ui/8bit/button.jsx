        ...
        <span className="relative inline-flex items-center justify-center gap-1.5">
          ...
          {variant !== "ghost" && variant !== "link" && size !== "icon" && (
            <>
              ...
              <div
                className="absolute top-1.5 -left-1.5 h-[calc(100%-12px)] w-1.5 bg-foreground dark:bg-ring" />
              <div
                className="absolute top-1.5 -right-1.5 h-[calc(100%-12px)] w-1.5 bg-foreground dark:bg-ring" />
              {variant !== "outline" && (
                <>
                  {/* Top shadow */}
